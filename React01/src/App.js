...
function App() {
  ...
  /*
    ...
    ** JSX 규칙
    ...
    2. 표현식 사용 가능
        JS문법을 사용 => return문 안에서 작성
        단, {}내에 if문은 사용할 수 없다

        - 조건이 하나일 떄 && 연산자를 사용, {}안에 
        - 조건이 두개일 때? 삼항연산자
        조건 ? 실행문1 : 실행문2
        - 조건이 세개 이상일 떄는 조건문을 표현식이 아닌, return 위쪽에서 사용
    ...
    4. 스타일링 적용
      ...
      b. 객체 형태로 작성
        ...
        예를 들어 css 에서는 background-color 라고 작성한다면,
  ...
  */
  ...
  return (
    ...
    <p style={txtStyle}>서유광의 리액트 홈페이지에 오신 것을 환영합니다!</p>

    {/* 조건이 하나 일 때 */}
    {/* {state === 'open' && <p>{name}님 반갑습니다.</p>} */}
    
    {/* 조건이 두개일 떄 */}
    {name === '강예진' ? <p>환영합니다!</p> : <p>죄송합니다. 이용하실수 없습니다.</p>}
